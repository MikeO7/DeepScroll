...
function Canvas({ slices, metadata, onStitchComplete, activeTool, hasFooter, isBeautified, onHistoryChange }) {
  ...
  const [finalImage, setFinalImage] = reactExports.useState(null);
  ...
  const editCanvasRef = reactExports.useRef(null);
  ...
  }, [finalImage, hasFooter, isBeautified, history, historyIndex]);
  reactExports.useEffect(() => {
    if (onHistoryChange) {
      onHistoryChange({
  ...
  function renderCanvas() {
    ...
    if (hasFooter) {
      ...
      const dateStr = metadata?.capturedAt ? new Date(metadata.capturedAt).toLocaleDateString() + " " + new Date(metadata.capturedAt).toLocaleTimeString() : (/* @__PURE__ */ new Date()).toLocaleDateString();
  ...
  const handleMouseUp = () => {
    ...
    if (activeTool === "redact") {
      applyRedact(startPos, currentPos);
      edited = true;
    }
    if (activeTool === "arrow") {
      applyArrow(startPos, currentPos);
      edited = true;
    }
    if (activeTool === "rect") {
      applyRect(startPos, currentPos);
      edited = true;
    }
    if (activeTool === "text") {
      applyText(currentPos);
    }
    if (activeTool === "crop") {
      applyCrop(startPos, currentPos);
      edited = true;
    }
...
const Crop = createLucideIcon("crop", __iconNode$b);
const __iconNode$a = [
...
const PanelsTopLeft = createLucideIcon("panels-top-left", __iconNode$6);
const __iconNode$5 = [
  [
    "path",
    {
...
function Toolbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-8 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md border border-white/10 rounded-full px-4 py-2 flex items-center gap-2 shadow-2xl z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pr-4 border-r border-white/10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCw, { size: 18 }),
          label: "Redo",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pr-4 border-r border-white/10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MousePointer2, { size: 18 }),
          label: "Select",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Eraser, { size: 18 }),
          label: "Blur",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 18 }),
          label: "Redact",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 18 }),
          label: "Draw",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 18 }),
          label: "Arrow",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 18 }),
          label: "Rectangle",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Crop, { size: 18 }),
          label: "Crop",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pr-4 border-r border-white/10 pl-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pl-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolButton,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 18 }),
          label: "Copy",
          onClick: onCopy
        }
      ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `
        ...
        ${primary ? "bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-500/20" : isActive ? "bg-white text-black" : disabled ? "text-neutral-400 opacity-20 cursor-not-allowed" : "text-neutral-400 hover:text-white hover:bg-white/10"}
      `,
      children: [
        icon,
...
function App() {
  ...
  const [isBeautified, setIsBeautified] = reactExports.useState(false);
  const [hasFooter, setHasFooter] = reactExports.useState(false);
  const [activeTool, setActiveTool] = reactExports.useState("select");
  const [historyState, setHistoryState] = reactExports.useState({ canUndo: false, canRedo: false });
...
`,
        children: [
          isBeautified && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-indigo-500/20 via-purple-500/20 to-pink-500/20 -z-10" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Canvas,
            {
              slices,
